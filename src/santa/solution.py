...
best_n = 0
best_limit = 0
best_total = 92514008574.2

benchmark =  12300000000
...
for n in [1.252525]:
    ...
    for limit_ in [67]:
        ...
        for s_ in range(len(submission.TripId)):
            ...
            print(submission.TripId[s_], ",weighteddistance,", path_opt_test(b))
        ...
        print("So far:", best_n, best_limit, "is best result ", best_total)
...
print(best_n, best_limit, "is best result ", best_total)
